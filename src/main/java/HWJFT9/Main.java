...
public class Main {
    public static void main(String[] args) {
        ...
        students.add(new Student("Anton", Arrays.asList(new Course("Math"), new Course("Geography"),
                new Course("Testing3"), new Course("Testing1"))));
        students.add(new Student("Lesy", Arrays.asList(new Course("Physics"), new Course("Biology"),
                new Course("Testing"), new Course("Testing2"))));
